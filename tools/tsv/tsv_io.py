from tools.common import exclusive_open_to_read
import time
import logging
import glob
import json
import random
from tools.common import ensure_directory
import six
import os
...
import progressbar
from tools.common import qd_tqdm as tqdm
...
class TSVDataset(object):
    ...
    def safe_write_data(self, rows, split, t=None, version=None,
        ...
        if generate_info is None:
            from tools.common import get_frame_info
...
def convert_data_to_yaml(
    ...
    if qd_format:
        ...
        if not op.isfile(dataset.get_data(split + 'X')):
            ...
            splitX = split + 'X'
            from tools.common import load_list_file
            info = {
            ...
            if is_train:
                ...
                if not op.isfile(caption_linelist):
                    tsv_writer(((a, b, 0) for a, b in
                               ...
                               caption_linelist)
                info['caption_linelist'] = caption_linelist
    from tools.common import write_to_yaml_file
